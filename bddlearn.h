...
int BddVar2Level( BddMan * p, int i ) { return p->pLevels[i]; }
int BddLevel2Var( BddMan * p, int i ) {
...
int BddLevel( BddMan * p, int i ) { return BddVar2Level(p, BddVar(p, i)); }
